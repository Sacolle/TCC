...
\infrule[Run]
    {\St{P, \{\}, []} \to_G^* \St{F_0, g, p}\quad\St{F_0, \{\}} \to_F^* \St{\KW{let}\;()\;e , \mathbb{F}}}
    {\mathbb{F} \vdash \St{\{e\}, ([],g),p,[]} \to^* \St{v, ([],g), p, m}} 
}
