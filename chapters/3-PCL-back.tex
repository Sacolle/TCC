...
Como $PCL_{back}$ não possui tipo \lstinline[language=C]|char|, utiliza-se dos números da codificação ASCII. Além disso, a sintaxe é extremamente similar. Se uma pessoa entende o exemplo em C, o corolário em $PCL_{back}$ apresenta mínimas barreiras sintáticas.
