...
\infrule[Var-lin]
	{}
	{\Gamma, x:\tau;U;R;L \vdash x : \tau \OR \Gamma;U, x:\tau;R;\text{rm}(x,L) }
...
\infrule[Deref-Ptr]
	{\Gamma;U;R;L \vdash e : \text{*}\tau \OR \Gamma';U';R';L' \quad \tau \text{ is nonlinear}}
	{\Gamma;U;R;L \vdash \text{*}e : \tau \OR \Gamma',U';\emptyset;R';L'} 

\infrule[Deref-Alias]
	{\Gamma;U;R;L \vdash e : @\tau'r \OR \Gamma';U';R';L' \quad \tau \text{ is nonlinear} \quad 'r \text{ is valid}}
	{\Gamma;U;R;L \vdash \text{*}e : \tau \OR \Gamma',U';\emptyset;R';L'} 
...
\infrule[Compose]
	{\Gamma;U;R;L \vdash e_1 : \tau_1 \OR \Gamma';U';R';L' \quad \Gamma';\emptyset;R';L' \vdash e_2 : \tau_2 \OR \Gamma'';U'';R'';L''}{\Gamma;U;R;L \vdash e_1;e_2 : \tau_2 \OR \Gamma'';U'';R'';L''} 

\infrule[Scope]
	{\Gamma;U;R;L \vdash e : \tau \OR \Gamma';U';R';L' \quad \Gamma \text{ is nonlinear}}
	{\Gamma;U;R;L \vdash \{e\}:\tau \OR \Gamma'\cap\Gamma;\emptyset;R;\forall (\_, n) \in \Gamma'/\Gamma, \text{rm}(n, L')} 
...
\infrule[Delete-var]
	{\Gamma;U;R;L \vdash e : \KW{int} \OR \Gamma';U';R';L'}
	{\Gamma,x:\tau;U;R;L \vdash \KW{delete}(x, e): Unit \OR \Gamma';\emptyset;R';rm(x, L')}

\infrule[Delete]
	{\Gamma;U;R;L \vdash e_1: \text{*}\tau \OR \Gamma';U';R';L' \quad \Gamma';\emptyset;R';L' \vdash e_2 : \KW{int} \OR \Gamma'';U'';R'';L''}
	{\Gamma;U;R;L \vdash \KW{delete}(e_1, e_2): Unit \OR \Gamma'';\emptyset;R'';L''}

\infrule[Var-Alias]
	{\Gamma;U;R;L \vdash e: @\tau'1 \OR \Gamma';U';R';L'}{\Gamma;U;R;L \vdash \KW{var}\;x : @\tau'r := e: Unit \OR \Gamma', x: \tau;\emptyset;R', ('1, 'r);L'}

\infrule[Var]
	{\Gamma;U;R;L \vdash e: \tau \OR \Gamma';U';R';L'}
	{\Gamma;U;R;L \vdash \KW{var}\;x : \tau := e: Unit \OR \Gamma', x: \tau;\emptyset;R';L'} 
