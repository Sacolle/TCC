...
\todo[inline]{Como \emph{definir} semântica operacional? }

%   2.2 Erros de memória
\section{Falhas de Memória}

\todo[inline]{Falar aqui de falhas, erro, fracasso}
