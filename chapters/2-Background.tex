...
Julgamentos de tipos, ou relações de tipo, de algum elemento $e$ com um tipo $\tau$ é dada na forma $e:\tau$. Essas regras são descritas como um conjunto de regras de inferência que atribuem tipos a termos. 

\todo[inline]{Aqui tinha uma seção sobre julgamento de tipos, mas não sei. Livro do Pierce. }
...
Essa classe de falhas compreende todos os problemas gerados com código concorrente/paralelo. Essa classe é extremamente complexa e está fora do escopo deste projeto. Caso fique de curiosidade ao leitor, o livro \todo{Citar um livro} trata bem desse assunto. 
